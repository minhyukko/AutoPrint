...
public class HelloWorld extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		new Label(parent, SWT.NONE).setText("Directory Location:");
...
//		combo.setText("C:\\Users\\minhy\\Downloads\\cs463-musical-chairs-thread-concurrency-master\\cs463-musical-chairs-thread-concurrency-master\\AppendString");
		...
		combo.select(0);
		combo.setBounds(1, 1, 1, 1);
	
		
		Button rm = new Button(parent, SWT.CHECK);
		rm.setText("Remove Print Statements");
		
		
		Button rmAll = new Button(parent, SWT.CHECK);
		rmAll.setText("Remove All Print Statements");
		
		new Label(parent, SWT.NONE).setText("Line Number Where Print Statement Starts:");
...
//		new Label().setText("Line Number Where Print Statement Ends:");
		new Label(parent, SWT.NONE).setText("Line Number Where Print Statement Ends:");
		Spinner spinner2 = new Spinner (parent, SWT.BORDER);
...
//		new Label().setText("Variables To Print:");
		new Label(parent, SWT.NONE).setText("Variables To Print:");
...
//		editItem.setMenu (submenu);
		...
		Button bard = new Button(parent, SWT.CHECK);
		...
		b.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
		        ...
		        for (int i = 0; i < setArr.length; i++) {
		            if(setArr[i].toString().substring(setArr[i].toString().length() - 5).equals(".java")) { // Checks whether the file ends with .txt extension or not.
...
//		});
//		
//		new Button(parent, SWT.PUSH).setText("Another button.");
